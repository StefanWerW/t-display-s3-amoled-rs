...
fn main() -> ! {
    ...
    let user_btn = Input::new(peripherals.GPIO21, InputConfig::default().with_pull(Pull::Down));
    let boot0_btn = Input::new(peripherals.GPIO0, InputConfig::default().with_pull(Pull::Down));
